...
export function useAgentPayment() {
    ...
    const queryAgentWithPayment = useCallback(async (agentName, priceInEth) => {
        try {
            setError(null);
            setLoading(true);
            if (!isConnected) {
            ...
            const client = await window.ethereum.request({
...
export async function fetchAgentAvatar(ensName) {
    try {
...
//# sourceMappingURL=useAgentPayment.js.map