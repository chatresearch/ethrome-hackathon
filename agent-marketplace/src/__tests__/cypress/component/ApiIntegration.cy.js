 ...
 */
const DataFetchingComponent = ({ agentId }) => {
    ...
    if (error)
        return (<div data-testid="error" className="text-red-500">
        Error: {error.message}
      </div>);
    return (<div data-testid="data-display">
      <h2>Agent: {agentId}</h2>
...
describe('API Integration Tests', () => {
    describe('Data Fetching', () => {
        ...
        it('should refetch data when agent ID changes', () => {
            ...
            const TestWrapper = () => {
                const [agentId, setAgentId] = react_1.default.useState('agent-1');
                return (<>
