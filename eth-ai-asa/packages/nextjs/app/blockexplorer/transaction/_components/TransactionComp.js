          ...
          <table className="table rounded-lg bg-base-100 w-full shadow-lg md:table-lg table-md">
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <scaffold_eth_1.Address address={transaction.from} format="long" onlyEnsOrAddress/>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  {!receipt?.contractAddress ? (transaction.to && <scaffold_eth_1.Address address={transaction.to} format="long" onlyEnsOrAddress/>) : (<span>
                      Contract Creation:
                      <scaffold_eth_1.Address address={receipt.contractAddress} format="long" onlyEnsOrAddress/>
                    </span>)}
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="form-control">
                  <textarea readOnly value={transaction.input} className="p-0 w-full textarea-primary bg-inherit h-[150px]"/>
                </td>
              </tr>
              <tr>
                <td>
                ...
                <td>
                  <ul>
                    {receipt?.logs?.map((log, i) => (<li key={i}>
