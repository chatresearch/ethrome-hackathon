        ...
        <table className="table text-xl bg-base-100 table-zebra w-full md:table-md table-sm">
          ...
          <tbody>
            ...
            return (<tr key={tx.hash} className="hover text-sm">
                    ...
                    <td className="w-2/12 md:py-4">
                      <scaffold_eth_1.Address address={tx.from} size="sm" onlyEnsOrAddress/>
                    </td>
                    <td className="w-2/12 md:py-4">
                      {!receipt?.contractAddress ? (tx.to && <scaffold_eth_1.Address address={tx.to} size="sm" onlyEnsOrAddress/>) : (<div className="relative">
                          <scaffold_eth_1.Address address={receipt.contractAddress} size="sm" onlyEnsOrAddress/>
