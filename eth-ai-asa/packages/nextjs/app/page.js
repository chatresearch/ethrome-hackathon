        ...
        <div className="grow bg-base-300 w-full mt-16 px-8 py-12">
          <div className="flex justify-center items-center gap-12 flex-col md:flex-row">
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
              <outline_1.SparklesIcon className="h-8 w-8 fill-primary mb-4"/>
              ...
              <link_1.default href="/agents" passHref className="btn btn-primary btn-sm">
                Browse Agents
              </link_1.default>
            </div>
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
              <outline_1.BugAntIcon className="h-8 w-8 fill-secondary mb-4"/>
              <p className="font-semibold mb-2">Debug</p>
              <p className="mb-4">Tinker with the AgentRegistry smart contract directly.</p>
              <link_1.default href="/debug" passHref className="btn btn-secondary btn-sm">
                Debug Contracts
              </link_1.default>
            </div>
            <div className="flex flex-col bg-base-100 px-10 py-10 text-center items-center max-w-xs rounded-3xl">
              <outline_1.MagnifyingGlassIcon className="h-8 w-8 fill-accent mb-4"/>
              <p className="font-semibold mb-2">Block Explorer</p>
              <p className="mb-4">Explore transactions on Base Sepolia.</p>
              <link_1.default href="/blockexplorer" passHref className="btn btn-accent btn-sm">
                Explorer
              </link_1.default>
            </div>
          </div>
