          ...
          <div className="space-y-3">
            <div className="flex space-x-4">
              <div>
                ...
                <scaffold_eth_1.Address address={faucetAddress} onlyEnsOrAddress/>
              </div>
              <div>
            ...
            <div className="flex flex-col space-y-3">
              <scaffold_eth_1.AddressInput placeholder="Destination Address" value={inputAddress ?? ""} onChange={value => setInputAddress(value)}/>
